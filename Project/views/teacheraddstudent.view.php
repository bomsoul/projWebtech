...
<div class="container">
        <span style="font-weight:bold" id = "obj">เพิ่มผู้เรียน </span>
        <form action="teacheraddstudent.php" method="post" enctype="multipart/form-data">
